			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<!-- 检索  -->
						<form action="titlequery/listTitlequery.do" method="post" name="userForm" id="userForm">
						<table style="margin-top:5px;">
							<tr>
                                ...
                                <td style="vertical-align:top;padding-left:2px;">
                                    <select class="chosen-select form-control" name="titlelevel" id="titlelevel" data-placeholder="请选择职称" style="vertical-align:top;width: 120px;">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">
							...
							<!-- 开始循环 -->	
							<c:choose>
								<c:when test="${not empty titlequeryList}">
									<c:if test="${QX.cha == 1 }">
									<c:forEach items="${titlequeryList}" var="user" varStatus="vs">
										<tr>
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
 	...
 	<script type="text/javascript">
		...
		function toExcel(){
			...
			var titlelevelVal = $("#titlelevel").val();
			window.location.href="<%=basePath%>titlequery/excel.do?keywords=" + encodeURI(encodeURI(keywordsVal)) + "&titlelevel=" + encodeURI(encodeURI(titlelevelVal));
		}
		</script>
    </body>
</html>
