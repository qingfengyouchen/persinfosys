					...
					<div class="row">
						...
						<form action="#" name="userInfoForm" id="userInfoForm" method="post">
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    <td style="width:140px;text-align: right;padding-top: 13px;">单位:</td>
                                    <td style="width:180px;padding-top: 13px;">${pd.USER_UNIT }</td>
                                    <td style="width:140px;text-align: right;padding-top: 13px;">行政级别:</td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top: 13px;">${pd.USER_POLIT }
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top: 13px;">${pd.INIT_DEGREE }
                                    </td>
