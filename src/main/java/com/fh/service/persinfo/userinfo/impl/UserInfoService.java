package com.fh.service.persinfo.userinfo.impl;
...
public class UserInfoService implements UserInfoManager{
	...
	public List<PageData> listPdPageUser(Page page)throws Exception{
		return (List<PageData>) dao.findForList("UserInfoMapper.userlistPage", page);
	}
	 ...
	 * @throws Exception
	 */
	public PageData getCadreCount(String value)throws Exception{
		return (PageData)dao.findForObject("UserInfoMapper.getCadreCount", value);
	}
}
